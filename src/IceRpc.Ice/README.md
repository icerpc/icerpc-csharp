...
The IceRpc.Ice NuGet package is part of the IceRPC + Slice integration, and includes two .NET assemblies:

- IceRpc.Ice.dll is used by the code generated by the [Slice compiler for C#][slice-tools]
...
[slice-tools]: https://www.nuget.org/packages/IceRpc.Ice.Tools
