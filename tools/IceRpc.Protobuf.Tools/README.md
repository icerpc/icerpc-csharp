...
[Google.Protobuf.Tools][google-protobuf-tools] package, additionaly it includes the `protoc` ARM64 binaries
for Linux and macOS from `[Google Protobuf release page][google-protobuf-release].
