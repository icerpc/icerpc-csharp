...
public class SlicingTests
{
    ...
    public void Slicing_Classes()
    {
        ...
        Assert.That(() =>
        {
            var decoder = new SliceDecoder(buffer, SliceEncoding.Slice1, activator: slicingActivator);
    ...
    public void Slicing_PreservedClasses()
    {
        ...
        decoder = new SliceDecoder(buffer, SliceEncoding.Slice1, activator: activator);
