...
public sealed class InterfaceTests
{
    ...
    [TestCase(typeof(PingableProxy), "::IceRpc::Ice::CodeGen::Tests::Pingable")]
    [TestCase(typeof(IPingableService), "::IceRpc::Ice::CodeGen::Tests::Pingable")]
    [TestCase(typeof(MyWidgetProxy), "::IceRpc::Ice::CodeGen::Tests::MyWidget")]
    [TestCase(typeof(IMyWidgetService), "::IceRpc::Ice::CodeGen::Tests::MyWidget")]
    [TestCase(typeof(MyOtherWidgetProxy), "::IceRpc::Ice::CodeGen::Tests::myOtherWidget")]
    [TestCase(typeof(IMyOtherWidgetService), "::IceRpc::Ice::CodeGen::Tests::myOtherWidget")]
    ...
    [TestCase(PingableProxy.DefaultServicePath, "/IceRpc.Ice.CodeGen.Tests.Pingable")]
    [TestCase(MyWidgetProxy.DefaultServicePath, "/IceRpc.Ice.CodeGen.Tests.MyWidget")]
    [TestCase(MyOtherWidgetProxy.DefaultServicePath, "/IceRpc.Ice.CodeGen.Tests.myOtherWidget")]
