...
{
    /// <summary>A fixed size numeric encoded on 1 byte such as bool or byte.</summary>
    F1 = 0,

    /// <summary>A fixed size numeric encoded on 2 bytes such as short.</summary>
    F2 = 1,

    /// <summary>A fixed size numeric encoded on 4 bytes such as int or float.</summary>
    F4 = 2,

    /// <summary>A fixed size numeric encoded on 8 bytes such as long or double.</summary>
    F8 = 3,
