...
public partial interface IIceObjectService
{
    ...
    [SliceOperation("ice_ids", Idempotent = true, Encoding = SliceEncoding.Slice1)]
    ...
    [SliceOperation("ice_isA", Idempotent = true, Encoding = SliceEncoding.Slice1)]
    ...
    [SliceOperation("ice_ping", Idempotent = true, Encoding = SliceEncoding.Slice1)]
