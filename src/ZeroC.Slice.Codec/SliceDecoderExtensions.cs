...
public static class SliceDecoderExtensions
{
        ...
        where TDictionary : ICollection<KeyValuePair<TKey, TValue>>
    {
        ...
        {
            decoder.IncreaseCollectionAllocation((long)count * (Unsafe.SizeOf<TKey>() + Unsafe.SizeOf<TValue>()));
        ...
        where T : struct
    {
        ...
        else
        {
            ...
            decoder.IncreaseCollectionAllocation((long)count * elementSize);
    ...
    public static T[] DecodeSequence<T>(this ref SliceDecoder decoder, DecodeFunc<T> decodeFunc) where T : notnull
    {
        ...
        {
            decoder.IncreaseCollectionAllocation((long)count * Unsafe.SizeOf<T>());
        ...
        where TElement : notnull
    {
        ...
        {
            decoder.IncreaseCollectionAllocation((long)count * Unsafe.SizeOf<TElement>());
