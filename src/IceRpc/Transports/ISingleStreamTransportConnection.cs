...
/// <summary>Represents a transport connection created by a single stream transport.</summary>
public interface ISingleStreamTransportConnection : ITransportConnection, IDisposable
{
