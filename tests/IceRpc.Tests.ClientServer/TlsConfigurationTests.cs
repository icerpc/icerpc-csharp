...
namespace IceRpc.Tests.ClientServer
{
    ...
    public class TlsConfigurationTests : ClientServerBaseTest
    {
        ...
        public async Task TlsConfiguration_With_CommonProtocol()
        {
            ...
            Assert.DoesNotThrowAsync(async () => await prx.IcePingAsync());
            Assert.That(prx.Connection!.ConnectionInformation, Is.AssignableTo<TcpConnectionInformation>());
            var connectionInformation = (TcpConnectionInformation)prx.Connection.ConnectionInformation;
