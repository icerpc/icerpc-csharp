...
{
    /// <summary>The base options class for configuring UDP based transports.</summary>
    ...
    public sealed class UdpClientOptions : UdpOptions
    {
    ...
    /// <summary>The options class for configuring <see cref="UdpClientTransport"/>.</summary>
    public sealed class UdpServerOptions : UdpOptions
    {
