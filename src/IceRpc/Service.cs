...
namespace IceRpc
{
    ...
    public class Service : IService, IDispatcher
    {
        ...
        private delegate ValueTask<(IceEncoding, PipeReader, PipeReader?)> IceDMethod(
            object target,
        ...
        public async ValueTask<OutgoingResponse> DispatchAsync(IncomingRequest request, CancellationToken cancel)
        {
            ...
            try
            {
                ...
                {
                    (IceEncoding payloadEncoding, PipeReader responsePayloadSource, PipeReader? responsePayloadSourceStream) =
