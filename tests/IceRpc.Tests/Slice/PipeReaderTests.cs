...
public class PipeReaderTests
{
    ...
    public async Task Calling_advance_to_on_an_empty_segment()
    {
        ...
        ReadResult readResult = await pipe.Reader.ReadSegmentAsync(SliceEncoding.Slice2, default);
    ...
    public async Task Reading_a_segment_piecemeal()
    {
        ...
        Task<ReadResult> task = pipe.Reader.ReadSegmentAsync(SliceEncoding.Slice2, default).AsTask();
    ...
    public void Reading_a_segment_with_an_invalid_size_fails()
    {
        ...
        Assert.That(
            async () => await pipeReader.ReadSegmentAsync(SliceEncoding.Slice2, default),
    ...
    public async Task Trying_to_read_an_incomplete_segment_returns_false()
    {
        ...
        bool success = pipe.Reader.TryReadSegment(SliceEncoding.Slice2, out ReadResult readResult);
    ...
    public void Trying_to_read_a_segment_with_an_invalid_size_fails()
    {
        ...
        Assert.That(
            () => _ = pipeReader.TryReadSegment(SliceEncoding.Slice2, out ReadResult readResult),
            Throws.TypeOf<InvalidDataException>());
    }
