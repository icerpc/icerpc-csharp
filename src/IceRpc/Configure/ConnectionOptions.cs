...
namespace IceRpc.Configure
{
    ...
    public sealed class ConnectionOptions
    {
        ...
        /// <summary>Gets or sets the connection establishment timeout. It can't be 0 and the default value is 10s.
        /// </summary>
        ...
        /// <summary>Gets or sets the maximum size in bytes of an incoming Ice or IceRpc protocol frame. It can't be
        /// less than 1KB and the default value is 1MB.</summary>
