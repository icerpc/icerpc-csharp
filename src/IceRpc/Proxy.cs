...
namespace IceRpc
{
    ...
    /// <seealso cref="IPrx"/>
    public sealed class Proxy : IEquatable<Proxy>, IEncodable
    {
        ...
        /// <inheritdoc/>
        public void Encode(IceEncoder encoder)
        {
            ...
            if (encoder.Encoding == Encoding.V11)
            {
                ...
                var proxyData = new ProxyData11(
                    ...
                    protocolMinor: 0,
                    Encoding);
                encoder.EncodeStruct(proxyData);
    ...
    public static class IceEncoderProxyExtensions
    {
        ...
        public static void EncodeNullableProxy(this IceEncoder encoder, Proxy? proxy)
        {
            ...
            {
                encoder.EncodeStruct(Identity.Empty);
            }
            else
            {
                encoder.EncodeStruct<ProxyData20>(default);
            }
        }
    ...
    public static class IceDecoderProxyExtensions
    {
        ...
        public static Proxy? DecodeNullableProxy(this IceDecoder decoder)
        {
            ...
            {
                var proxyData = decoder.DecodeStruct<ProxyData20>();
