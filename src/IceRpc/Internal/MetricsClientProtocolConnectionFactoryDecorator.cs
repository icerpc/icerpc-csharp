...
internal class MetricsClientProtocolConnectionFactoryDecorator : IClientProtocolConnectionFactory
{
    ...
    internal MetricsClientProtocolConnectionFactoryDecorator(IClientProtocolConnectionFactory decoratee) =>
