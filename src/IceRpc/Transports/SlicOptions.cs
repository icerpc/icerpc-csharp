...
namespace IceRpc.Transports
{
    ...
    public class SlicOptions
    {
        ...
        /// <summary>The Slic packet maximum size in bytes. It can't be less than 1KB and the default value is
        /// 32KB. Slic is only used for the Ice2 protocol, this setting is ignored when using the Ice1
        /// protocol.</summary>
        ...
        /// <summary>The Slic stream buffer maximum size in bytes. The stream buffer is used when streaming
        /// data with a stream Slice parameter. It can't be less than 1KB and the default value is twice the
        /// Slic packet maximum size. Slic is only used for the Ice2 protocol, this setting is ignored when
        /// using the Ice1 protocol.
        /// </summary>
