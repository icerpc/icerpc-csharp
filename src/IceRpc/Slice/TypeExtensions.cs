...
public static class TypeExtensions
{
    ...
    /// <param name="type">The type of the class generated by the Slice compiler.</param>
    ...
    /// <param name="type">The type of the class or interface generated by the Slice compiler.</param>
