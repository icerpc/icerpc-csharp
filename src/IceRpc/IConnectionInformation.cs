...
namespace IceRpc
{
    ...
    /// <summary>The IColocConnectionInformation interface provides information for a coloc socket.</summary>
    ...
    /// <summary>The ITcpConnectionInformation interface provides properties for an IP socket.</summary>
    ...
    /// <summary>The ITcpConnectionInformation interface provides properties for a TCP socket.</summary>
