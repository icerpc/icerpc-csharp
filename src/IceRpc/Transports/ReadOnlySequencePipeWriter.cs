...
namespace IceRpc.Transports
{
    ...
    /// boolean to notify the pipe writer implementations that no more data will be written. This class is useful for
    /// implementing multiplexed stream pipe writers and to optimize the writting of a <see cref="ReadOnlySequence{T}"/>
    /// for transports that support a gather write APIs</summary>
