...
/// <summary>A middleware that logs dispatch messages to an <see cref="ILogger" />. When used in conjunction with the
/// telemetry middleware, install the logger middleware after the telemetry middleware, this way the logger can include
