...
{
    [Timeout(5000)]
    public class MultiplexedNetworkStreamTests : MultiplexedNetworkStreamFactoryBaseTest
    {
        [SetUp]
        ...
        public async Task MultiplexedNetworkStream_Abort(StreamError errorCode)
        {
            Task<(int, IMultiplexedNetworkStream)> serverTask = ReceiveAsync();

            // Create client stream and send one byte.
            IMultiplexedNetworkStream clientStream = ClientMultiplexedStreamFactory.CreateStream(true);
            ...
            IMultiplexedNetworkStream clientStream2 = ClientMultiplexedStreamFactory.CreateStream(true);
            ...
            {
                IMultiplexedNetworkStream serverStream =
                    await ServerMultiplexedStreamFactory.AcceptStreamAsync(default);
        ...
        [TestCase(false, 3, 1024, 1024 * 1024)]
        public async Task MultiplexedNetworkStream_StreamSendReceiveAsync(
            bool flowControl,
            int bufferCount,
            int sendSize,
            int recvSize)
        {
            ...
            IMultiplexedNetworkStream serverStream = await ServerMultiplexedStreamFactory.AcceptStreamAsync(default);
            _ = ServerMultiplexedStreamFactory.AcceptStreamAsync(default).AsTask();
        ...
        [Test]
        public void MultiplexedNetworkStream_SendAsync_Cancellation()
        {
            IMultiplexedNetworkStream stream = ClientMultiplexedStreamFactory.CreateStream(true);
        ...
        [Test]
        public void MultiplexedNetworkStream_ReceiveAsync_Cancellation()
        {
            IMultiplexedNetworkStream stream = ClientMultiplexedStreamFactory.CreateStream(true);
            using var source = new CancellationTokenSource();
            source.Cancel();
        ...
        [Test]
        public async Task MultiplexedNetworkStream_ReceiveAsync_Cancellation2Async()
        {
            IMultiplexedNetworkStream stream = ClientMultiplexedStreamFactory.CreateStream(true);
            _ = ClientMultiplexedStreamFactory.AcceptStreamAsync(default).AsTask();
        ...
        [TestCase(1024, 1024 * 1024)]
        public async Task MultiplexedNetworkStream_StreamReaderWriterAsync(int sendSize, int recvSize)
        {
        ...
        [TestCase(false)]
        [TestCase(true)]
        public async Task MultiplexedNetworkStream_StreamReaderWriterCancelationAsync(bool cancelClientSide)
        {
            Task<IMultiplexedNetworkStream> serverAcceptStream = AcceptServerStreamAsync();
        ...
        [Test]
        public async Task MultiplexedNetworkStream_StreamReaderWriterCompressorAsync()
        {
            IMultiplexedNetworkStream clientStream = ClientMultiplexedStreamFactory.CreateStream(true);
            _ = ClientMultiplexedStreamFactory.AcceptStreamAsync(default).AsTask();
