...
namespace ZeroC.Slice.IceGen.Tests.TypeIdAttributeTestNamespace;
...
public sealed class TypeIdAttributeTests
{
    ...
    [TestCase(typeof(MyClass), "::ZeroC::Slice::IceGen::Tests::TypeIdAttributeTestNamespace::MyClass")]
    [TestCase(typeof(MyOtherClass), "::ZeroC::Slice::IceGen::Tests::TypeIdAttributeTestNamespace::myOtherClass")]
