...
namespace IceRpc.Transports
{
    ...
    public interface IMultiplexedStream : IDuplexPipe
    {
        ...
        /// <summary>Registers the called which is called when the stream is shutdown.</summary>
        ...
        /// <summary>Sets the action which is called when the peer <see cref="IDuplexPipe.Input"/> completed.</summary>
        /// <param name="action">The callback to register.</param>
