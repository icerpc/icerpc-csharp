...
Slice::CsVisitor::writeMarshal(const OperationPtr& operation, bool returnType)
{
    ...
    {
        _out << nl << "var bitSequence = iceEncoder.WriteBitSequence(" << bitSequenceSize << ");";
    }
    ...
    {
        _out << nl << "if (iceEncoder.Encoding != IceRpc.Encoding.V11)";
        _out << sb;
    }
...
Slice::CsVisitor::writeUnmarshal(const OperationPtr& operation, bool returnType)
{
    ...
    if (read11ReturnLast)
    {
        _out << nl << "if (iceDecoder.Encoding != IceRpc.Encoding.V11)";
        _out << sb;
    }
...
Slice::Gen::TypesVisitor::visitClassDefEnd(const ClassDefPtr& p)
{
    ...
    _out << nl << "public static readonly new IceRpc.IceReader<" << name << "> IceReader =";
    _out.inc();
    ...
    _out << sp;
    emitEditorBrowsableNeverAttribute();
    _out << nl << "public static readonly new IceRpc.IceReader<" << name << "?> NullableIceReader =";
    _out.inc();
    ...
    _out << sp;
    emitEditorBrowsableNeverAttribute();
    _out << nl << "public static readonly new IceRpc.IceWriter<" << name << "> IceWriter =";
    _out.inc();
    ...
    _out << sp;
    emitEditorBrowsableNeverAttribute();
    _out << nl << "public static readonly new IceRpc.IceWriter<" << name << "?> NullableIceWriter =";
    _out.inc();
    ...
    _out << nl << "/// <inherit-doc/>";
    emitEditorBrowsableNeverAttribute();
    _out << nl << "public " << name << "(IceRpc.IceDecoder? iceDecoder)";
    if (hasBaseClass)
    {
        // We call the base class constructor to initialize the base class fields.
        _out.inc();
        _out << nl << ": base(iceDecoder)";
        _out.dec();
    }
    _out << sb;
...
Slice::Gen::TypesVisitor::writeMarshaling(const ClassDefPtr& p)
{
    ...
    _out << sp;
    _out << nl << "protected override void IceWrite(IceRpc.IceEncoder iceEncoder, bool firstSlice)";
    _out << sb;
    _out << nl << "if (firstSlice)";
    _out << sb;
    _out << nl << "iceEncoder.IceStartFirstSlice(_iceAllTypeIds";
    if (preserved || basePreserved)
    {
        _out << ", IceSlicedData";
    }
    ...
    _out << nl << "else";
    _out << sb;
    _out << nl << "iceEncoder.IceStartNextSlice(IceTypeId";
    if (p->compactId() >= 0)
    {
        _out << ", _compactTypeId";
    }
    ...
    if(base)
    {
        _out << nl << "iceEncoder.IceEndSlice(false);";
        _out << nl << "base.IceWrite(iceEncoder, false);";
    }
    else
    {
         _out << nl << "iceEncoder.IceEndSlice(true);"; // last slice
    }
    _out << eb;
    ...
    _out << "iceDecoder.IceStartFirstSlice();";
    _out << eb;
    _out << nl << "else";
    _out << sb;
    _out << nl << "iceDecoder.IceStartNextSlice();";
    _out << eb;
...
Slice::Gen::TypesVisitor::visitExceptionEnd(const ExceptionPtr& p)
{
    ...
    _out << nl << "if (firstSlice)";
    _out << sb;
    _out << nl << "IceSlicedData = iceDecoder.IceStartFirstSlice();";
    ...
    _out << nl << "if (firstSlice)";
    _out << sb;
    _out << nl << "iceEncoder.IceStartFirstSlice(_iceAllTypeIds, IceSlicedData, errorMessage: Message, origin: Origin);";
    _out << eb;
    _out << nl << "else";
    _out << sb;
    _out << nl << "iceEncoder.IceStartNextSlice(_iceAllTypeIds[0]);";
    _out << eb;
    writeMarshalDataMembers(dataMembers, ns, Slice::ExceptionType);

    if(base)
    {
        _out << nl << "iceEncoder.IceEndSlice(false);"; // the current slice is not last slice
        _out << nl << "base.IceWrite(iceEncoder, false);"; // the next one is not the first slice
    }
    else
    {
        _out << nl << "iceEncoder.IceEndSlice(true);"; // this is the last slice.
    }
    _out << eb;
...
Slice::Gen::TypesVisitor::visitStructStart(const StructPtr& p)
{
    ...
    _out << nl << "public static readonly IceRpc.IceReader<" << name << "> IceReader =";
    _out.inc();
    ...
    _out << nl << "/// <summary>An <see cref=\"IceRpc.IceWriter{T}\"/> for <see cref=\""
         << name << "\"/> instances.</summary>";
    _out << nl << "public static readonly IceRpc.IceWriter<" << name << "> IceWriter =";
    _out.inc();
...
Slice::Gen::TypesVisitor::visitStructEnd(const StructPtr& p)
{
    ...
    _out << nl << "/// <param name=\"iceDecoder\">The buffer iceDecoder.</param>";
    _out << nl << "public " << name << "(IceRpc.IceDecoder iceDecoder)";
    _out << sb;
    ...
    _out << nl << "/// <param name=\"iceEncoder\">The buffer iceEncoder.</param>";
    _out << nl << "public readonly void IceWrite(IceRpc.IceEncoder iceEncoder)";
    _out << sb;
...
Slice::Gen::TypesVisitor::visitEnum(const EnumPtr& p)
{
    ...
    _out << sp;
    _out << nl << "public static readonly IceRpc.IceReader<" << name << "> IceReader = Read" << p->name()
        << ";";

    _out << sp;
    _out << nl << "public static readonly IceRpc.IceWriter<" << name << "> IceWriter = Write;";
    ...
    _out << sp;
    _out << nl << "public static void Write(this IceRpc.IceEncoder iceEncoder, " << name << " value) =>";
    _out.inc();
    if (p->underlying())
    {
        _out << nl << "iceEncoder.Write" << builtinSuffix(p->underlying()) << "((" << underlying << ")value);";
    }
    else
    {
        _out << nl << "iceEncoder.WriteSize((int)value);";
    }
    _out.dec();
    _out << eb;
}
    ...
    if (generateRequestClass)
    {
        ...
        for (auto operation : operationList)
        {
            ...
            if (params.size() > 0 && (params.size() > 1 || !params.back()->stream()))
            {
                ...
                _out << nl;
                writeOutgoingRequestIceWriter(operation);
    ...
    if (generateResponseClass)
    {
        ...
        for (auto operation : p->operations())
        {
            ...
            if (returns.size() > 0 && (returns.size() > 1 || !returns.back()->stream()))
            {
                ...
                _out << nl;
                writeIncomingResponseIceReader(operation);
                _out << ",";
                _out << nl << "connection,";
                _out << nl << "invoker);";
                _out.dec();
...
void
Slice::Gen::ProxyVisitor::writeOutgoingRequestIceWriter(const OperationPtr& operation)
{
    InterfaceDefPtr interface = InterfaceDefPtr::dynamicCast(operation->container());
    string ns = getNamespace(interface);
    ...
    {
        _out << "(IceRpc.IceEncoder iceEncoder, ";
...
void
Slice::Gen::ProxyVisitor::writeIncomingResponseIceReader(const OperationPtr& operation)
{
    ...
    bool defaultIceReader = returnType.size() == 1 && operation->returnBitSequenceSize() == 0 &&
    ...
    if (generateRequestClass)
    {
        ...
        for (auto operation : operationList)
        {
            ...
            if (params.size() > 0 && (params.size() > 1 || !params.back()->stream()))
            {
                ...
                _out << nl << "dispatch,";
                _out << nl;
                writeIncomingRequestIceReader(operation);
                _out << ");";
                _out.dec();
                _out.dec();
            }
    ...
    if (generateResponseClass)
    {
        ...
        for (auto operation : operationList)
        {
            ...
            if (returns.size() > 0 && (returns.size() > 1 || !returns.back()->stream()))
            {
                ...
                _out << nl;
                writeOutgoingResponseIceWriter(operation);
                string classFormat = opFormatTypeToString(operation);
                if (classFormat != "default")
                {
                    _out << "," << nl << classFormat;
...
Slice::Gen::DispatcherVisitor::visitOperation(const OperationPtr& operation)
{
    ...
    // The 'this.' is necessary only when the operation name matches one of our local variable (dispatch, iceDecoder etc.)
    if (operation->hasMarshaledResult())
    {
...
void
Slice::Gen::DispatcherVisitor::writeIncomingRequestIceReader(const OperationPtr& operation)
{
    InterfaceDefPtr interface = operation->interface();
    string ns = getNamespace(interface);
    ...
    bool defaultIceReader = params.size() == 1 && operation->paramsBitSequenceSize() == 0 && !params.front()->tagged();
...
void
Slice::Gen::DispatcherVisitor::writeOutgoingResponseIceWriter(const OperationPtr& operation)
{
    InterfaceDefPtr interface = InterfaceDefPtr::dynamicCast(operation->container());
    string ns = getNamespace(interface);
