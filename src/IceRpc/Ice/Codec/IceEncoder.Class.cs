...
public ref partial struct IceEncoder
{
        ...
        else
        {
                ...
                _classContext.ClassFormat == ClassFormat.Sliced)
            {
                ...
                else
                {
                    ...
                    _classContext.Current.IndirectionMap ??= new Dictionary<IceClass, int>();
    ...
    private void EncodeInstance(IceClass v)
    {
        ...
        {
            _classContext.InstanceMap ??= new Dictionary<IceClass, int>();
    ...
    {
        // The current class/exception format, can be either Compact or Iced.
        ...
        internal Dictionary<IceClass, int>? InstanceMap;
