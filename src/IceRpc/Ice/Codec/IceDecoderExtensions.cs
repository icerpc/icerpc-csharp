...
public static class IceDecoderExtensions
{
    ...
    /// <summary>Decodes a dictionary with an optional value type (T? in Ice).</summary>
    /// <typeparam name="TDictionary">The type of the returned dictionary.</typeparam>
    /// <typeparam name="TKey">The type of the keys in the dictionary.</typeparam>
    /// <typeparam name="TValue">The type of the values in the dictionary.</typeparam>
    /// <param name="decoder">The Ice decoder.</param>
    ...
    /// <summary>Decodes a sequence where the element type is an optional Ice type (T?).</summary>
    /// <typeparam name="T">The type of the elements in the array.</typeparam>
    /// <param name="decoder">The Ice decoder.</param>
    ...
    public static T?[] DecodeSequenceOfOptionals<T>(this ref IceDecoder decoder, DecodeFunc<T> decodeFunc)
    {
        int count = decoder.DecodeSize();
        if (count == 0)
        {
