...
namespace IceRpc
{
    ...
    public sealed partial class IceDecoder
    {
        ...
        public Proxy? DecodeNullableProxy()
        {
            ...
            {
                var proxyData = DecodeStruct<ProxyData20>();
        ...
        /// <summary>Decodes a struct generated by the Slice compiler.</summary>
        /// <paramtype name="T">The type of the struct to decode.</paramtype>
        /// <returns>The decoded struct.</returns>
        public T DecodeStruct<T>() where T : struct, IDecodable => new() { IceDecoder = this };
        ...
        internal Endpoint DecodeEndpoint11(Protocol protocol)
        {
            ...
            var encoding = DecodeStruct<Encoding>();
