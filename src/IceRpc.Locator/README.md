This package contains a locator intercetpr for [IceRPC .NET](https://www.nuget.org/packages/IceRpc), that allows IceRPC applications to use an Ice location service.
