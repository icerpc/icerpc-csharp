...
namespace IceRpc.Transports.Internal.Slic
{
    ...
    internal sealed class StreamSlicFrameWriter : ISlicFrameWriter
    {
        ...
        public ValueTask WriteStreamFrameAsync(
            ...
            CancellationToken cancel)
        {
            Debug.Assert(buffers.Span[0].Span[..SlicDefinitions.FrameHeader.Length].Equals(SlicDefinitions.FrameHeader));
            ...
            Ice20Encoder.EncodeFixedLengthSize(bufferSize, headerData.Span[1..sizeLength]);
            Ice20Encoder.EncodeFixedLengthSize(stream.Id, headerData.Span[(1 + sizeLength)..streamIdLength]);
