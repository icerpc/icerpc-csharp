...
Slice::Gen::ProxyVisitor::visitInterfaceDefEnd(const InterfaceDefPtr& p)
{
    ...
    _out << nl << "global::System.Collections.Generic.IEnumerable<IceRpc.Endpoint> endpoints,";
    _out << nl << "IceRpc.Connection? connection,";
    _out << nl << "IceRpc.ProxyOptions options) =>";
    _out << nl << "new " << impl << "(path, protocol, encoding, endpoints, connection, options);";
    _out.dec();
    _out << sp;
    _out << nl << "public " << name << " Create(";
    _out.inc();
    ...
    _out << nl << "IceRpc.Connection? connection,";
    _out << nl << "IceRpc.ProxyOptions options) =>";
    _out << nl << "new " << impl << "(identity, facet, encoding, endpoints, connection, options);";
    _out.dec();
    _out << sp;
    ...
    _out << nl << "IceRpc.Connection? connection,";
    _out << nl << "IceRpc.ProxyOptions options)";
    _out << nl << ": base(path, protocol, encoding, endpoints, connection, options)";
    _out.dec();
    _out << sb;
    _out << eb;
    _out << sp;
    ...
    _out << nl << "IceRpc.Connection? connection,";
    _out << nl << "IceRpc.ProxyOptions options)";
    _out << nl << ": base(identity, facet, encoding, endpoints, connection, options)";
    _out.dec();
    _out << sb;
    _out << eb;
    _out << eb;
