...
| `icerpc-ice-client`         | A project template for creating an IceRPC + Ice (ice protocol) client console application.                      |
| `icerpc-ice-server`         | A project template for creating an IceRPC + Ice (ice protocol) server console application.                      |
