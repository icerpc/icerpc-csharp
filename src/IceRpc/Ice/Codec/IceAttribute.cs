...
public sealed class IceAttribute : Attribute
{
    /// <summary>Gets the name of the file that contains the Ice definitions.</summary>
    public string SourceFileName { get; }

    /// <summary>Constructs a new instance of <see cref="IceAttribute" />.</summary>
    /// <param name="sourceFileName">The name of the source file.</param>
    public IceAttribute(string sourceFileName) => SourceFileName = sourceFileName;
}
