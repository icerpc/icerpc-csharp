...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Compiler           | Types used by Slice compilers (such as [slicec]) to describe Slice definitions. A Slice compiler serializes these types to `stdout`; code generators later read and decode this output.                                                                                        |
