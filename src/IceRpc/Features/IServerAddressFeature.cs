...
public interface IServerAddressFeature
{
    ...
    /// <value>The list of alternatives to <see cref="IceRpc.ServerAddress" />. It is empty when <see
    /// cref="ServerAddress" /> is <see langword="null" />.</value>.
    ...
    /// <value>The main server address. It is <see langword="null" /> if there's no server address to use for the
    /// invocation.</value>
