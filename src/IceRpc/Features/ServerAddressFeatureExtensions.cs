...
{
    /// <summary>Extension methods for <see cref="IServerAddressFeature" />.</summary>
    /// <param name="feature">The server address feature.</param>
    extension(IServerAddressFeature feature)
    {
        /// <summary>Tries to remove a server address from this server address feature. The server address is
        /// added to the removed server addresses of the feature.</summary>
        ...
        /// <summary>Rotates the server addresses the first alt server address becomes the main server address
        /// and the main server address becomes the last alt server address.</summary>
