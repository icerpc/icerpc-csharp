...
public static class ServiceAddressIceDecoderExtensions
{
                ...
                switch (transportCode)
                {
                    case TransportCode.Tcp:
                        serverAddress = decoder.DecodeTcpServerAddressBody(
                            ServiceAddressIceEncoderExtensions.TcpName);
                        break;

                    case TransportCode.Ssl:
                        serverAddress = decoder.DecodeTcpServerAddressBody(
                            ServiceAddressIceEncoderExtensions.SslName);
                        break;
                    ...
                    default:
                        ...
                        serverAddress = new ServerAddress(
                            ...
                            transport: ServiceAddressIceEncoderExtensions.OpaqueName,
                            builder.ToImmutable());
                        break;
                }
            }
    ...
    private static ServerAddress DecodeTcpServerAddressBody(this ref SliceDecoder decoder, string transport)
    {
        ...
        if (body.Timeout != ServiceAddressIceEncoderExtensions.DefaultTcpTimeout)
        {
