...
namespace IceRpc.Transports.Internal
{
    ...
    internal class SlicMultiplexedStream : IMultiplexedStream, IValueTaskSource<(int, bool)>
    {
        ...
        private readonly SlicMultiplexedStreamFactory _connection;
        private long _id = -1;
        ...
        internal SlicMultiplexedStream(SlicMultiplexedStreamFactory connection, long streamId, ISlicFrameReader reader, ISlicFrameWriter writer)
        {
