...
namespace IceRpc.Tests.Internal
{
    public class SocketNetworkConnectionTests
    {
        ...
        [Test]
        public void NetworkSocketConnection_ConnectAndGetMultiplexedNetworkStreamFactoryAsync_NotSupportedException()
        {
            var connection = new SocketNetworkConnection(
                new NetworkSocketStub(isDatagram: false),
                Endpoint.FromString("ice+tcp://host"),
            ...
            Assert.ThrowsAsync<NotSupportedException>(
                    async () => await connection.ConnectAndGetMultiplexedNetworkStreamFactoryAsync(default));
        }

        [Test]
        public async Task NetworkSocketConnection_ConnectAndGetNetworkStreamAsync()
        {
            var connection = new SocketNetworkConnection(
                new NetworkSocketStub(isDatagram: false),
                Endpoint.FromString("ice+tcp://host"),
            ...
            await connection.ConnectAndGetNetworkStreamAsync(default);
