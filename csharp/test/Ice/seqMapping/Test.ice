...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<byte> CByteS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<bool> CBoolS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<short> CShortS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<int> CIntS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<long> CLongS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<float> CFloatS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<double> CDoubleS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<string> CStringS;

sequence<Object> AObjectS;
[cs:generic(List)] sequence<Object> LObjectS;
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<Object> CObjectS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<Object*> CObjectPrxS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<S> CStructS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<SD> CStructSD;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<I*> CIPrxS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<CR> CCRS;
...
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<En> CEnS;

[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<int> CustomIntS;
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<CV> CustomCVS;

[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<CustomIntS> CustomIntSS;
[cs:generic(IceRpc.Test.SeqMapping.Custom)] sequence<CustomCVS> CustomCVSS;
