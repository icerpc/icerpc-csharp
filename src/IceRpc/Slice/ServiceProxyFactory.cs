...
/// <summary>Creates a new service proxy. This delegate is used by <see cref="ISliceDecodeFeature"/> and
...
/// <param name="encodeFeature">The Slice encode feature from the request, or null if this feature is not set.</param>
