...
namespace IceRpc.Tests.Internal
{
    ...
    public class MultiplexedNetworkStreamTests : MultiplexedNetworkStreamFactoryBaseTest
    {
        ...
        public async Task MultiplexedNetworkStream_Abort(StreamError errorCode)
        {
            ...
            IMultiplexedNetworkStream clientStream2 = ClientMultiplexedNetworkStreamFactory.CreateStream(true);
            ...
            async Task<(int, IMultiplexedNetworkStream)> ReceiveAsync()
            {
                ...
                _ = ServerMultiplexedNetworkStreamFactory.AcceptStreamAsync(default).AsTask();
        ...
        [TestCase(false, 3, 1024, 1024 * 1024)]
        public async Task MultiplexedNetworkStream_StreamSendReceiveAsync(bool flowControl, int bufferCount, int sendSize, int recvSize)
        {
            IMultiplexedNetworkStream clientStream = ClientMultiplexedNetworkStreamFactory.CreateStream(true);
