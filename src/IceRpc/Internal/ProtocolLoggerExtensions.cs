...
namespace IceRpc.Internal
{
    ...
    internal static partial class ProtocolLoggerExtensions
    {
        ...
        internal static void LogReceivedInitializeFrame(this ILogger logger, MultiStreamSocket socket)
        {
            ...
            {
                logger.LogReceivedInitializeFrame(socket.PeerIncomingFrameMaxSize!.Value);
            }
        }
        ...
        internal static void LogReceivedRequest(this ILogger logger, IncomingRequest request) =>
            logger.LogReceivedRequest(request.Path, request.Operation, request.PayloadSize, request.PayloadEncoding);
        ...
        internal static void LogRetryRequestRetryableException(
            ...
            Exception? ex) =>
            logger.LogRetryRequestRetryableException(request.Path,
                                                     request.Operation,
                                                     retryPolicy,
                                                     attempt,
                                                     maxAttempts,
