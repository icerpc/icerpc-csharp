...
public static class ConnectionCacheServiceCollectionExtensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        /// <code
        ///     source="../../docfx/examples/IceRpc.Extensions.DependencyInjection.Examples/AddIceRpcConnectionCacheExamples.cs"
        ///     region="DefaultConnectionCache"
        ///     lang="csharp" />
        /// The resulting singleton is a default connection cache. If you want to customize this connection cache,
        /// add an <see cref="IOptions{T}" /> of <see cref="ConnectionCacheOptions" /> to your DI container:
        /// <code
        ///     source="../../docfx/examples/IceRpc.Extensions.DependencyInjection.Examples/AddIceRpcConnectionCacheExamples.cs"
        ...
        /// </description></item>
        /// </list>
        /// The following example shows a connection cache that uses Slic over TCP for icerpc connections and
        /// keeps the default duplex transport (TCP) for ice connections.
        /// <code
        ///     source="../../docfx/examples/IceRpc.Extensions.DependencyInjection.Examples/AddIceRpcConnectionCacheExamples.cs"
        ...
        /// </example>
        public IServiceCollection AddIceRpcConnectionCache() =>
            services
