...
public static class TypeExtensions
{
    ...
    /// <param name="type">The type of a class, struct or interface generated by the Slice compiler.</param>
    ...
    /// <exception cref="ArgumentException">Thrown if <paramref name="type" /> is not an interface or a struct.
    /// </exception>
