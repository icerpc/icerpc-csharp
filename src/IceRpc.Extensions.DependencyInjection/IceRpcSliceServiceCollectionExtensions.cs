...
{
    /// <summary>Adds a singleton for interface T. The implementation is a proxy generated by the Slice compiler.
    /// </summary>
    /// <typeparam name="T">The interface generated by the Slice compiler that the proxy implements.</typeparam>
    /// <typeparam name="TProxy">The proxy struct that implements T.</typeparam>
