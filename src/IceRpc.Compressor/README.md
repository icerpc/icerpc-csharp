...
// Add the compressor middleware to the dispatch pipeline. Chatbot is a class that
// implements the IGreeterService interface generated by the Slice compiler.
