...
{
    /// <summary>This abstract class can be extended by pipe writers to provide a <see cref="PipeWriter.WriteAsync"/>
    /// method with a <see cref="ReadOnlySequence{T}"/> source. It also provides a boolean to complete the pipe writer
    /// once the write is done. The IceRPC core optimizes the copy of a <see cref="PipeReader"/> to a <see
    /// cref="ReadOnlySequencePipeWriter"/>.</summary>
