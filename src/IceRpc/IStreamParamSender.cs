...
namespace IceRpc
{
    ...
    /// <see cref="NetworkStream"/>.</summary>
    public interface IStreamParamSender
    {
        ...
        /// the given <see cref="NetworkStream"/>.</summary>
        ...
        Task SendAsync(NetworkStream stream, Func<System.IO.Stream, (CompressionFormat, System.IO.Stream)>? streamCompressor);
    }
}
