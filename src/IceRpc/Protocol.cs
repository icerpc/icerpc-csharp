...
public class Protocol
{
    ...
    /// <value><see langword="true" /> if the protocol supports fragments; otherwise, <see langword="false" />.
    /// </value>
    ...
    /// <value><see langword="true" /> if the protocol supports payload writer interceptors; otherwise,
    /// <see langword="false" />.</value>
