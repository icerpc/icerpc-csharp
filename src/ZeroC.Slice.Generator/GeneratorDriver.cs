...
internal static class GeneratorDriver
{
        ...
        IList<string> usings)
    {
        ...
        TransformAsync(ImmutableList<SliceFile> symbolFiles, (string key, string value)[] options)
        {
            ...
            // Use the informational version (e.g., "0.7.0-preview.1") which is the semver string from
            // the <Version> MSBuild property. Fall back to the assembly version (e.g., "0.7.0.0") if
