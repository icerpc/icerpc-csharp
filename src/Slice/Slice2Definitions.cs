...
public static class Slice2Definitions
{
    ...
    /// <summary>Represents the smallest possible value of a <c>varint62</c> Slice type. This field is constant.</summary>
    public const long VarInt62MinValue = -2_305_843_009_213_693_952; // -2^61

    /// <summary>Represents the largest possible value of a <c>varint62</c> Slice type. This field is constant.</summary>
    public const long VarInt62MaxValue = 2_305_843_009_213_693_951; // 2^61 - 1

    /// <summary>Represents the smallest possible value of a <c>varuint62</c> Slice type. This field is constant.</summary>
    public const ulong VarUInt62MinValue = 0;

    /// <summary>Represents the largest possible value of a <c>varuint62</c> Slice type. This field is constant.</summary>
