...
{
    [Test]
    public void Endpoint_Initialization()
    {
    ...
    [TestCase("icerpc://[::0]")]
    [TestCase("ice://[::0]?foo=bar&xyz=true")]
    [TestCase("icerpc://[::0]?xyz=false&xyz=true&foo=&b=")]
    [TestCase("icerpc://host:10000?xyz=foo")]
    [TestCase("icerpc://host:10000?transport=coloc")]
    [TestCase("ice://localhost?transport=udp")]
    [TestCase("ice://host:10000")]
    [TestCase("icerpc://host:10000?xyz")]
    [TestCase("icerpc://host:10000?xyz&adapter-id=ok")]
    [TestCase("IceRpc://host:10000")]
