    ...
    int tag)
{
    ...
    if (type->isInterfaceType())
    {
        out << ", " << encodeAction(optionalType, scope);
    }
    else if (builtin)
    {
        out << ", " << encodeAction(optionalType, scope) << ", size: ";
    ...
    else if (seq)
    {
        ...
        {
            out << ", " << encodeAction(optionalType, scope, readOnly);
        }
        ...
        else
        {
            ...
            out << ", " << encodeAction(optionalType, scope, readOnly)
                << ", size: " << elementType->minWireSize() << " * (" << param << "?.Count() ?? 0), " << tagFormat;
        }
    }
    else
    {
