...
namespace IceRpc.Tests.Internal
{
    ...
    public sealed class InvocationEventSourceTests : IDisposable
    {
        ...
        public void InvocationEventSource_RequestStart()
        {
            ...
            _eventSource.RequestStart(new OutgoingRequest
                {
                    Operation = "ice_id",
                    Path = "/service"
                });
        ...
        public void InvocationEventSource_RequestStop()
        {
            ...
            _eventSource.RequestStop(new OutgoingRequest
                {
                    Operation = "ice_id",
                    Path = "/service"
                });
        ...
        public void InvocationEventSource_RequestCanceled()
        {
            ...
            _eventSource.RequestCanceled(new OutgoingRequest
                {
                    Operation = "ice_id",
                    Path = "/service"
                });
        ...
        public void InvocationEventSource_RequestFailed()
        {
            ...
            _eventSource.RequestFailed(new OutgoingRequest
                {
                    Operation = "ice_id",
                    Path = "/service"
                },
