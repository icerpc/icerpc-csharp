...
/// <summary>Represents a delegate that encodes into an Slice encoder.</summary>
/// <param name="encoder">The Slice encoder.</param>
public delegate void EncodeAction(ref SliceEncoder encoder);

/// <summary>Represents a delegate that encodes a value with an Slice encoder.</summary>
