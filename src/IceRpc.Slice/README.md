...
The IceRPC framework allows you to make RPCs with the serialization format and [IDL][idl] of your choice. The
IceRpc.Slice assembly/package represents the IceRPC-Slice integration: it helps the Slice compiler for C# implement
Slice interfaces and operations with IceRPC.
...
// Class IceRpc.Slice.Service is an IceRPC dispatcher implemented using Chatbot and helper code provided by the
// IGreeterService interface generated by the Slice compiler.
