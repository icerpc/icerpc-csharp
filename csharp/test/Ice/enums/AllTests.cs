...
namespace ZeroC.Ice.Test.Enums
{
    public static class AllTests
    {
        public static async Task RunAsync(TestHelper helper)
        {
            ...
            TestHelper.Assert((int)ByteEnum.benum3 == 10);
            TestHelper.Assert((int)ByteEnum.benum4 == 11);
            TestHelper.Assert((int)ByteEnum.benum5 == 20);
            TestHelper.Assert((int)ByteEnum.benum6 == 21);
            TestHelper.Assert((int)ByteEnum.benum7 == 30);
            TestHelper.Assert((int)ByteEnum.benum8 == 31);
            TestHelper.Assert((int)ByteEnum.benum9 == 40);
            TestHelper.Assert((int)ByteEnum.benum10 == 41);
            TestHelper.Assert((int)ByteEnum.benum11 == 226);

            TestHelper.Assert((int)ShortEnum.senum1 == 3);
            TestHelper.Assert((int)ShortEnum.senum2 == 4);
            TestHelper.Assert((int)ShortEnum.senum3 == 10);
            TestHelper.Assert((int)ShortEnum.senum4 == 11);
            TestHelper.Assert((int)ShortEnum.senum5 == 20);
            TestHelper.Assert((int)ShortEnum.senum6 == 21);
            TestHelper.Assert((int)ShortEnum.senum7 == 30);
            TestHelper.Assert((int)ShortEnum.senum8 == 31);
            TestHelper.Assert((int)ShortEnum.senum9 == 40);
            TestHelper.Assert((int)ShortEnum.senum10 == 41);
            TestHelper.Assert((int)ShortEnum.senum11 == 32766);

            TestHelper.Assert((int)IntEnum.ienum1 == 0);
            TestHelper.Assert((int)IntEnum.ienum2 == 1);
            TestHelper.Assert((int)IntEnum.ienum3 == 10);
            TestHelper.Assert((int)IntEnum.ienum4 == 11);
            TestHelper.Assert((int)IntEnum.ienum5 == 20);
            TestHelper.Assert((int)IntEnum.ienum6 == 21);
            TestHelper.Assert((int)IntEnum.ienum7 == 30);
            TestHelper.Assert((int)IntEnum.ienum8 == 31);
            TestHelper.Assert((int)IntEnum.ienum9 == 40);
            TestHelper.Assert((int)IntEnum.ienum10 == 41);
            TestHelper.Assert((int)IntEnum.ienum11 == 2147483647);
            TestHelper.Assert((int)IntEnum.ienum12 == 2147483646);
