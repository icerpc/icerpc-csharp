...
public static class RouterExtensions
{
    ...
    /// <remarks>This default path is specific to service interfaces that carry the
    /// <see cref="DefaultServicePathAttribute" /> attribute. The <typeparamref name="TService" /> type parameter must
    /// correspond to such an interface.</remarks>
