...
namespace IceRpc.Tests.SliceInternal
{
    ...
    public class BuiltInTypesSequencesTests
    {
        ...
        /// <summary>Tests `EncodeSequenceWithBitSequence` with a value type. Tests `DecodeSequenceWithBitSequence` 
        ...
        public void BuiltInTypesSequences_FixedSizeNumeric_Optional(int size)
        {
            var encoder = new IceEncoder(_bufferWriter, _encoding);
            var decoder = new IceDecoder(_buffer, _encoding);
            IList<int?> p1 = Enumerable.Range(0, size).Select(i => (int?)(i % 2 == 0 ? null : i)).ToList();
        ...
        /// <summary>Tests `EncodeSequenceWithBitSequence` with a reference type. Tests `DecodeSequenceWithBitSequence` 
        ...
        /// <summary>Tests `EncodeSequence` and `DecodeSequence` with a value type. Also tests `EncodeVarLong`
        ...
        public void BuiltInTypesSequences_VarLong(int size){
            ...
            IEnumerable<long> r1 = decoder.DecodeSequence(1, (ref IceDecoder decoder) => decoder.DecodeVarLong());
            IEnumerable<long> r2 = decoder.DecodeSequence(1, (ref IceDecoder decoder) => decoder.DecodeVarLong());
            IEnumerable<long> r3 = decoder.DecodeSequence(1, (ref IceDecoder decoder) => decoder.DecodeVarLong());
            IEnumerable<long> r4 = decoder.DecodeSequence(1, (ref IceDecoder decoder) => decoder.DecodeVarLong());
