...
- IceRpc.ServiceGenerator.dll provides a [source generator] that you enable with the `[Service]` attribute.
...
// The [Service] attribute instructs the Slice Service source generator (provided by
// IceRpc.ServiceGenerator.dll) to implement IDispatcher by directing "greet" requests to
