...
public sealed class FunctionBuilder : IBuilder, IAttributeBuilder<FunctionBuilder>, ICommentBuilder<FunctionBuilder>
{
    ...
    private readonly List<string> _thisArguments = [];
    ...
    {
        _thisArguments.AddRange(arguments);
        return this;
    }
    ...
    public CodeBlock Build()
    {
        ...
        // Add this constructor call if present
        if (_thisArguments.Count > 0)
        {
            code.Write($"\n    : this({string.Join(", ", _thisArguments)})");
        }
