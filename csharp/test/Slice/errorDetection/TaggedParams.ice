...
interface I
{
    ...
    tag(0) string? r7();         // ok
    tag(-1) double? r8();         // invalid tag
    tag(0x80000001) byte? r9();           // out of range
    tag(1.1) bool? r10();          // invalid tag
    tag(2) bool? r11();          // ok
    tag(E::e1) int? r12();        // ok
    ...
    void i7(tag(0) string? p);         // ok
    void i8(tag(-1) double? p);         // invalid tag
    void i9(tag(0x80000001) byte? p);           // out of range
    void i10(tag(1.1) bool? p);          // invalid tag
    void i11(tag(2) bool? p);          // ok
    ...
    void o7(out tag(0) string? p);         // ok
    void o8(out tag(-1) double? p);         // invalid tag
    void o9(out tag(0x80000001) byte? p);           // out of range
    void o10(out tag(1.1) bool? p);          // invalid tag
    void o11(out tag(2) bool? p);          // ok
    ...
    tag(0) int? io6(tag(E::e2) int? p, out tag(E::e1) int? o);   // duplicate tag
