...
namespace IceRpc.Tests.Encoding
{
    ...
    public class ProxyTests
    {
        ...
        public void Proxy_EncodingVersioning(byte encodingMajor, byte encodingMinor, string str)
        {
            ...
            var prx2 = _data[0].AsReadOnlyMemory().Read(IServicePrx.IceReader,
                                                        encoding,
                                                        skipTaggedParams: false,
                                                        connection: null,
                                                        prx.Invoker);
        ...
        public void Proxy_EndpointLess(byte encodingMajor, byte encodingMinor)
        {
            ...
            IServicePrx prx1 = _data[0].AsReadOnlyMemory().Read(IServicePrx.IceReader,
                                                                encoding,
                                                                skipTaggedParams: false,
                                                                _connection,
                                                                invoker: null);
